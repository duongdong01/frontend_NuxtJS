    ...
    <div class="bg-[#f6f6f6] flex flex-col mb-20 pt-20 pb-20 sm:px-14 px-8">
      ...
      <div class="flex mt-5 justify-center mx-auto sm:space-x-8  space-x-4">
        <div class="w-36 flex justify-end">
          <img src="https://scontent.fhan2-1.fna.fbcdn.net/v/t1.6435-9/52591436_720237038377890_7401268411050754048_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=f15S960TUmYAX86RjSk&_nc_ht=scontent.fhan2-1.fna&oh=00_AT-VmyDlZJBGsG5WBrd1dfK3pcjOW9VZOYvLKUz42NQyMw&oe=635A8E6D" alt="photo">
        </div>
